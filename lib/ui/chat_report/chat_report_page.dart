...
import 'package:baeit/ui/chat_report/chat_report_bloc.dart';
...
class ChatReportPage extends BlocStatefulWidget {
  final String chatRoomUuid;
  final String defendantUuid;

  ChatReportPage({required this.chatRoomUuid, required this.defendantUuid});
...
class ChatReportState extends BlocState<ChatReportBloc, ChatReportPage> {
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                customText(
                                  reportTextController.text.characters.length.toString(),
                                  style: TextStyle(
                              ...
                              child: bottomButton(
                                  ...
                                  onPress: () {
                                    bloc.add(ReportEvent(
                                        ...
                                        defendantUuid: widget.defendantUuid,
  ...
  blocListener(BuildContext context, state) {
    ...
    if (state is DuplicateReportState) {
      showToast(context: context, text: '이미 신고한 채팅방입니다');
    }
  }

  @override
  ChatReportBloc initBloc() {
    return ChatReportBloc(context)..add(ChatReportInitEvent());
  }
}
