...
import 'package:baeit/ui/review/review_report_bloc.dart';
...
class ReviewReportPage extends BlocStatefulWidget {
  final String classReviewUuid;

  ReviewReportPage({required this.classReviewUuid});

  @override
  BlocState<BaseBloc, BlocStatefulWidget> buildState() {
    return ReviewReportState();
  }
}

class ReviewReportState extends BlocState<ReviewReportBloc, ReviewReportPage> {
                              ...
                              child: bottomButton(
                                  ...
                                  onPress: () {
                                    bloc.add(ReportEvent(
                                        classReviewUuid: widget.classReviewUuid,
  ...
  blocListener(BuildContext context, state) {
    ...
    if (state is DuplicateReportState) {
      showToast(context: context, text: '이미 신고한 후기입니다');
    }
  }

  @override
  ReviewReportBloc initBloc() {
    return ReviewReportBloc(context)..add(ReviewReportInitEvent());
  }
}
